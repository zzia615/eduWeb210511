<%@ Page Title="确定预约" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TeacherOrder.aspx.cs" Inherits="TeacherOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
	...
	<div class="content-edit">
		...
		<div class="layui-form-item">
			<label class="layui-form-label"><i class="layui-icon layui-icon-username"></i>科目</label>
			<div class="layui-input-block">
				<asp:TextBox runat="server" class="layui-input" name="kemu" ID="kemu" type="text" 
				lay-verify="required" lay-reqtext="科目是必填项，岂能为空？" placeholder="请输入" autocomplete="off" ReadOnly="true"></asp:TextBox>
			</div>
		</div>
		<div class="layui-form-item">
